...
export const attrs = T.fn([template(T_lens)], T_lens)
export const attrsNamed = T.fnVarN(0, T.string, T_lens)
export const attrsOf = T.fn([T.instanceOf(Object)], T_lens)
export const attrsOr = T.fn([T_lens, template(T_lens)], T_lens)
